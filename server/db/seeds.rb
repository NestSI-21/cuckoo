...
Company.create(name: 'Assure Hedge',
...
Company.create(name: 'Deemaze', description: 'Software agency building digital products and services.',
               status: 'a ver', logo: 'kappa')
Company.create(name: 'Fidizzi',
...
Company.create(name: 'Fucking Amazing',
...
Company.create(name: 'Good Barber',
...
Company.create(name: 'srgsoftware.io',
