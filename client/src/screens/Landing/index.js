    ...
    <div className={content}>
      ...
      <main>
        ...
        <section className={allDevices}>
          ...
          />
          <p>
            Cuckoo is a platform that can be used through your desktop computer, phone, or any other
            device.
          </p>
        </section>
        ...
        <section className={how} id='how'>
          ...
          <div className={howMessage}>
            ...
            <p>
              ...
              access to what will be happening in the following days, so that you don&apos;t miss a
              thing.
            </p>
          </div>
        </section>
        ...
        <section className={create}>
          ...
          <div className={createMessage}>
            ...
            <p>
              To create a Cuckoo (Slack Post that will be stored on the platform) you will only need
              to tell us the type of cuckoo you want to create, give it a title and a category, all
              the other fields are not required. Your Cuckoo will be
              <span> sent to Slack </span>
              as well as <span>stored</span> on the platform.
            </p>
            <div className={steps}>
              <div className={step}>
                <h1>1.</h1>
